    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid-4">
          ...
          {/* Column 2: Dermatologie Médicale & Esthétique */}
          <div className="footer-col">
            <h3 className="footer-col-title">Dermatologie Médicale</h3>
            ...
            <h3 className="footer-col-title footer-title-sub">Dermatologie Esthétique</h3>
            <ul className="footer-col-links">
          ...
          {/* Column 3: Chirurgie & Prévention */}
          <div className="footer-col">
            <h3 className="footer-col-title">Chirurgie Dermatologique</h3>
            <ul className="footer-col-links">
            ...
            <h3 className="footer-col-title footer-title-sub">Prévention &amp; Dépistage</h3>
            <ul className="footer-col-links">
          ...
          {/* Column 4: Pages & Horaires */}
          <div className="footer-col">
            <h3 className="footer-col-title">Navigation &amp; Accès</h3>
            <ul className="footer-col-links">
